...
type RoskoStyles = Omit<TemplateStyleSlots, "page"> & {
	page: Style;
	sidebarColumn: Style;
...
export const RoskoPage = ({ page, pageIndex }: TemplatePageProps) => {
	const data = useRender();
	const { metadata } = data;
	const { colors, styles } = useRoskoTemplate();
...
const useRoskoTemplate = (): RoskoTemplate => {
